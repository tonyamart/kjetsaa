...
norm <- read.csv("../data/kjetsaa_corpus/kjetsaa_norm_tokenized.csv")
...
```{r, echo=T, message=F, warning=F, fig.keep='none', eval=F}
...
# saveRDS(global_res, file = "../data/results/keywords_res_kjetsaa_norm.rds")
```
...
res_k <- readRDS("../data/results/keywords_res_kjetsaa_norm.rds")
...
```{r,  echo=T, message=FALSE, warning=FALSE, fig.keep='none', eval=F}
bar_zr <- zeta_count(AUTHOR = "Baratynskij E.A.",
                         N_POEMS = 245,
                         SAMPLE_SIZE = 38000,
                         NORM = "5k")
...
```{r,  echo=T, warning=F, message=F, fig.keep='none', eval=F}
fet_zr <- zeta_count(AUTHOR = "Fet A.A.",
                        N_POEMS = 600,
                        SAMPLE_SIZE = 36000,
                         NORM = "5k")
...
# saveRDS(global_res, file = "../data/results/keywords_res_5k_norm.rds")
```
