...
```{r}
k_centroids <- read_csv("../data/centroids_kjetsaa_wordlists_kjetsaa-norm.csv")
...
```{r}
plot_tiles(k_res, plot_title = "Kjetsaa's Norm as the reference corpus")

ggsave("../plots/hm_kjetsaa.png",
       plot = last_plot(),
       bg = "white", dpi = 300,
       width = 15, height = 10)
```
...
ggsave("../plots/listsim_kjetsaa.png", 
       plot = last_plot(), 
       bg = "white", dpi = 300,
       width = 8, height = 6)
```
...
```{r}
b_centroids <- read_csv("../data/centroids_kjetsaa_wordlists_5k.csv")
...
```{r}
plot_tiles(b_res, plot_title = "Bootstrapped 5k as the reference corpus")

ggsave("../plots/hm_5k.png",
       plot = last_plot(),
       bg = "white", dpi = 300,
       width = 15, height = 10)
```
...
```{r}
plot_summary(b_res, 
             plot_title = "Bootstrapped 5k as the reference corpus")

ggsave("../plots/listsim_5k.png", 
       plot = last_plot(), 
       bg = "white", dpi = 300,
       width = 8, height = 6)
```
...
```{r}
r_centroids <- read_csv("../data/centroids_random_lists.csv")
...
r_centroids <- r_centroids %>% 
  mutate(measure = "random",
         group = ceiling(run / 25),
         group = paste0(measure, "_", group))

r_centroids %>% count(author, group, pos)
```

```{r}
r_mat <- transform_matrix(r_centroids)
...
```{r}
plot_tiles(r_res, plot_title = "Random lists")

ggsave("../plots/hm_random.png",
       plot = last_plot(),
       bg = "white", dpi = 300,
       width = 15, height = 10)
```
